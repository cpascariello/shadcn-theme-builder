...
interface ColorEditorContentProps {
  /** When true, all sections start collapsed (for mobile) */
  defaultCollapsed?: boolean;
}

export function ColorEditorContent({ defaultCollapsed = false }: ColorEditorContentProps) {
    ...
    <>
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-4">
        ...
        {filteredGroups.map((group) => (
          <CollapsibleSection key={group.label} title={group.label} defaultOpen={isSearching || !defaultCollapsed}>
        ...
        {sectionMatches("Fonts") && (
          <CollapsibleSection title="Fonts" defaultOpen={!defaultCollapsed}>
        ...
        {sectionMatches("Border Radius") && (
          <CollapsibleSection title="Border Radius" defaultOpen={!defaultCollapsed}>
            <div className="flex items-center gap-3">
              <Slider
        ...
        {sectionMatches("Spacing") && (
          <CollapsibleSection title="Spacing" defaultOpen={!defaultCollapsed}>
            <div className="flex items-center gap-3">
              <Slider
        ...
        {sectionMatches("Shadows") && (
          <CollapsibleSection title="Shadows" defaultOpen={!defaultCollapsed}>
            <ShadowControls />
          </CollapsibleSection>
        )}

        {sectionMatches("Letter Spacing") && (
          <CollapsibleSection title="Letter Spacing" defaultOpen={!defaultCollapsed}>
            <div className="flex items-center gap-3">
              <Slider
